...
class SuppliersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create supplier" do
    assert_difference('Supplier.count') do
      post suppliers_url, params: { supplier: { address: @supplier.address, company_name: @supplier.company_name } }
    end
  ...
  test "should update supplier" do
    patch supplier_url(@supplier), params: { supplier: { address: @supplier.address, company_name: @supplier.company_name } }
